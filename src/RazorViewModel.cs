...
namespace Sharp.RazorToString
{
    public abstract class RazorViewModel
    {
        ...
        /// <summary>
        ///   Gets or sets <see cref="ViewDataDictionary"/> can accessed in the view by using ViewBag or ViewData.
        /// </summary>
        public ViewDataDictionary ViewData
        {
            get => _viewData ??= new ViewDataDictionary(new EmptyModelMetadataProvider(), new ModelStateDictionary());
        ...
        public string Path
        {
            get
            {
                if (_viewPath is { }) return _viewPath;
